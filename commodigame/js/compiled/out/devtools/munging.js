...
var o__39644__auto__ = f;
return (o__39644__auto__["toString"]).call(o__39644__auto__);
} else {
return "";
}
...
try{var o__39644__auto___40567 = t;
(o__39644__auto___40567["cljs$lang$ctorPrWriter"]).call(o__39644__auto___40567,t,writer);
}catch (e40566){var __40568 = e40566;
}
...
var char_code = (function (){var o__39644__auto__ = (new String(char$));
return (o__39644__auto__["charCodeAt"]).call(o__39644__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39644__auto__ = String;
return (o__39644__auto__["fromCharCode"]).call(o__39644__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40569 = num_code;
switch (G__40569) {
case (1):
return (185);
...
var o__39644__auto__ = String;
return (o__39644__auto__["fromCharCode"]).call(o__39644__auto__,superscript_code);
});
/**
...
}catch (e40571){var _e__39651__auto__ = e40571;
return false;
}})())){
...
var vec__40572 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40572,(0),null);
...
var temp__5276__auto____$1 = (o40575["dependencies_"]);
if(cljs.core.truth_(temp__5276__auto____$1)){
var o40576 = temp__5276__auto____$1;
return (o40576["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31326__auto___40583 = arguments.length;
var i__31327__auto___40584 = (0);
while(true){
if((i__31327__auto___40584 < len__31326__auto___40583)){
args__31333__auto__.push((arguments[i__31327__auto___40584]));

var G__40585 = (i__31327__auto___40584 + (1));
i__31327__auto___40584 = G__40585;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31334__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40579){
var vec__40580 = p__40579;
var ns_detector = cljs.core.nth.call(null,vec__40580,(0),null);
...
var G__40586 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40587 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40586;
remaining_tokens = G__40587;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40577){
var G__40578 = cljs.core.first.call(null,seq40577);
var seq40577__$1 = cljs.core.next.call(null,seq40577);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__40578,seq40577__$1);
});
...
var vec__40591 = cljs.core.split_with.call(null,(function (p1__40590_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40590_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40591,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40591,(1),null);
...
var vec__40594 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40594,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40594,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40597 = cljs.core.rest.call(null,remaining_tokens);
var G__40598 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40597;
name_tokens = G__40598;
continue;
} else {
...
var vec__40601 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40601,(0),null);
var arity = cljs.core.nth.call(null,vec__40601,(1),null);
var vec__40604 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40604,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40604,(1),null);
var vec__40607 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40607,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40607,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40607,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40607,(3),null);
...
var vec__40613 = result;
var munged_ns = cljs.core.nth.call(null,vec__40613,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40613,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40613,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40613,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40613,(4),null);
var arity = cljs.core.nth.call(null,vec__40613,(5),null);
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__40617 = temp__5276__auto__;
var munged_name = cljs.core.nth.call(null,vec__40617,(0),null);
var args = cljs.core.nth.call(null,vec__40617,(1),null);
var vec__40620 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40620,(0),null);
var name = cljs.core.nth.call(null,vec__40620,(1),null);
...
var G__40623 = (arity + (1));
var G__40624 = (function (){var temp__5276__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5276__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40625){
var vec__40626 = p__40625;
var arity = cljs.core.nth.call(null,vec__40626,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40626,(1),null);
...
return cljs.core.get.call(null,arities,p1__40629_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40630_SHARP_);
...
var args__31333__auto__ = [];
var len__31326__auto___40637 = arguments.length;
var i__31327__auto___40638 = (0);
while(true){
if((i__31327__auto___40638 < len__31326__auto___40637)){
args__31333__auto__.push((arguments[i__31327__auto___40638]));

var G__40639 = (i__31327__auto___40638 + (1));
i__31327__auto___40638 = G__40639;
continue;
} else {
}
break;
...
var argseq__31334__auto__ = ((((1) < args__31333__auto__.length))?(new cljs.core.IndexedSeq(args__31333__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31334__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40633){
var vec__40634 = p__40633;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40634,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40631){
var G__40632 = cljs.core.first.call(null,seq40631);
var seq40631__$1 = cljs.core.next.call(null,seq40631);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__40632,seq40631__$1);
});
...
var map__40642 = options;
var map__40642__$1 = ((((!((map__40642 == null)))?((((map__40642.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40642.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40642):map__40642);
var include_ns_QMARK_ = cljs.core.get.call(null,map__40642__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40642__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40642__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40642__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40643 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40643,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40643,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40643,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40643,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40643,(4),null);
var arity = cljs.core.nth.call(null,vec__40643,(5),null);
...
var o__39644__auto__ = f;
return (o__39644__auto__["getBasis"]).call(o__39644__auto__);
});
/**
...
}catch (e40647){var _e__39651__auto__ = e40647;
...
var G__40648 = (obj[cljs.core.first.call(null,path)]);
var G__40649 = cljs.core.rest.call(null,path);
obj = G__40648;
path = G__40649;
continue;
} else {
...
return (function (accum,p__40650){
var vec__40651 = p__40650;
var bit = cljs.core.nth.call(null,vec__40651,(0),null);
var protocol = cljs.core.nth.call(null,vec__40651,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40654){
var vec__40655 = p__40654;
var ns = cljs.core.nth.call(null,vec__40655,(0),null);
var name = cljs.core.nth.call(null,vec__40655,(1),null);
var selector = cljs.core.nth.call(null,vec__40655,(2),null);
...
return (function (p__40659){
var vec__40660 = p__40659;
var munged_name = cljs.core.nth.call(null,vec__40660,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40660,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40660,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40658_SHARP_){
return (obj[cljs.core.first.call(null,p1__40658_SHARP_)]);
});})(name,sorted_matches,vec__40660,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1507075206944
