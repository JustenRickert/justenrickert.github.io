...
var len__31326__auto___40685 = arguments.length;
var i__31327__auto___40686 = (0);
while(true){
if((i__31327__auto___40686 < len__31326__auto___40685)){
args__31333__auto__.push((arguments[i__31327__auto___40686]));

var G__40687 = (i__31327__auto___40686 + (1));
i__31327__auto___40686 = G__40687;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31334__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq40683){
var G__40684 = cljs.core.first.call(null,seq40683);
var seq40683__$1 = cljs.core.next.call(null,seq40683);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__40684,seq40683__$1);
});
...
return (function (p1__40688_SHARP_){
return (p1__40688_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1507075207101
