...
return (new CustomEvent(event_name,(function (){var obj36659 = {"detail":data};
return obj36659;
})()));
} else {
...
var f = (function (){var pred__36666 = cljs.core._EQ_;
var expr__36667 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36666.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36667))){
return ((function (pred__36666,expr__36667){
return (function (p1__36660_SHARP_){
return console.warn(p1__36660_SHARP_);
});
;})(pred__36666,expr__36667))
} else {
if(cljs.core.truth_(pred__36666.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36667))){
return ((function (pred__36666,expr__36667){
return (function (p1__36661_SHARP_){
return console.debug(p1__36661_SHARP_);
});
;})(pred__36666,expr__36667))
} else {
if(cljs.core.truth_(pred__36666.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36667))){
return ((function (pred__36666,expr__36667){
return (function (p1__36662_SHARP_){
return console.error(p1__36662_SHARP_);
});
;})(pred__36666,expr__36667))
} else {
return ((function (pred__36666,expr__36667){
return (function (p1__36663_SHARP_){
return console.log(p1__36663_SHARP_);
});
;})(pred__36666,expr__36667))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36670){
var map__36671 = p__36670;
var map__36671__$1 = ((((!((map__36671 == null)))?((((map__36671.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36671.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36671):map__36671);
var opts = map__36671__$1;
var eval_fn = cljs.core.get.call(null,map__36671__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36673_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__36675,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1507075199742
